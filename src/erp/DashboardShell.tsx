...
const menuByRole: Record<UserRole, { label: string; icon: string; page: ErpPage; children?: { label: string; page: ErpPage }[] }[]> = {
  admin: [
    ...
    { label: 'AI Call Center', icon: '🤖', page: 'ai-call-center' },
    ...
    { label: 'Staff Management', icon: '🧑‍💼', page: 'staff' },
    { label: 'Class & Section', icon: '🏫', page: 'class-section' },
    { label: 'Subjects', icon: '📖', page: 'subjects' },
    { label: 'Timetable', icon: '🗓️', page: 'timetable' },
    { label: 'Attendance', icon: '✅', page: 'attendance' },
    { label: 'Fee Management', icon: '💰', page: 'fees' },
    { label: 'Scholarships', icon: '🎗️', page: 'scholarships' },
  ...
  teacher: [
    ...
    { label: 'My Calls', icon: '🤖', page: 'ai-call-center' },
    { label: 'Timetable', icon: '🗓️', page: 'timetable' },
    { label: 'Attendance', icon: '✅', page: 'attendance' },
  ...
  student: [
    ...
    { label: 'Timetable', icon: '🗓️', page: 'timetable' },
    { label: 'Attendance', icon: '✅', page: 'attendance' },
    { label: 'Result / Report Card', icon: '🏆', page: 'result' },
  ...
  parent: [
    { label: 'Dashboard', icon: '🏠', page: 'dashboard' },
    { label: "My Child", icon: '🧒', page: 'parent-child' },
    { label: 'Attendance', icon: '✅', page: 'attendance' },
    { label: 'Homework', icon: '📘', page: 'homework' },
    { label: 'Result / Report Card', icon: '🏆', page: 'result' },
    { label: 'Fees', icon: '💳', page: 'fees' },
    { label: 'Scholarships', icon: '🎗️', page: 'scholarships' },
    { label: 'My Calls & Appointments', icon: '🤖', page: 'ai-call-center' },
    { label: 'Timetable', icon: '🗓️', page: 'timetable' },
    { label: 'Notices', icon: '📢', page: 'notices' },
    { label: 'Messages', icon: '💬', page: 'messages' },
  ],
